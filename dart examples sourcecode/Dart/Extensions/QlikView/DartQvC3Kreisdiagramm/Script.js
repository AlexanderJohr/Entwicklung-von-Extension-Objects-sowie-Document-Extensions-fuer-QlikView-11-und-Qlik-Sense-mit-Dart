...
["dart.async", "dart:async", , P, {
  ...
  Future_wait_handleError: {
    "^": "Closure:33;box_0,eagerError_1,result_2",
  ...
  Future_wait_closure: {
    "^": "Closure:40;box_0,eagerError_3,result_4,pos_5",
  ...
  _Completer: {
    ...
    }, "completeError$1", "call$2", "call$1", "get$completeError", 2, 2, 41, 16, 17, 18]
  },
  _AsyncCompleter: {
    "^": "_Completer;future",
  ...
  _Future__propagateToListeners_handleValueCallback: {
    "^": "Closure:43;box_1,listener_3,sourceValue_4,zone_5",
    call$0: function() {
  ...
  _ForwardingStreamSubscription: {
    ...
    }, "call$2", "get$_handleError", 4, 0, 48, 17, 18],
...
["dart.dom.html", "dart:html", , W, {
  ...
  HtmlElement: {
    "^": "Element;",
    "%": "HTMLAppletElement|HTMLBRElement|HTMLCanvasElement|HTMLContentElement|HTMLDListElement|HTMLDataListElement|HTMLDetailsElement|HTMLDialogElement|HTMLDirectoryElement|HTMLDivElement|HTMLFieldSetElement|HTMLFontElement|HTMLFrameElement|HTMLFrameSetElement|HTMLHRElement|HTMLHeadingElement|HTMLHtmlElement|HTMLKeygenElement|HTMLLIElement|HTMLLabelElement|HTMLLegendElement|HTMLMapElement|HTMLMarqueeElement|HTMLMetaElement|HTMLMeterElement|HTMLModElement|HTMLOptGroupElement|HTMLOptionElement|HTMLOutputElement|HTMLParagraphElement|HTMLParamElement|HTMLPictureElement|HTMLPreElement|HTMLProgressElement|HTMLQuoteElement|HTMLShadowElement|HTMLSpanElement|HTMLTableCaptionElement|HTMLTableCellElement|HTMLTableColElement|HTMLTableDataCellElement|HTMLTableElement|HTMLTableHeaderCellElement|HTMLTableRowElement|HTMLTableSectionElement|HTMLTemplateElement|HTMLTextAreaElement|HTMLTitleElement|HTMLUListElement|HTMLUnknownElement;HTMLElement"
  },
  AnchorElement: {
    "^": "HtmlElement;rel},type},href}",
    toString$0: function(receiver) {
...
["dart.js", "dart:js", , P, {
  ...
  JsObject__convertDataTree__convert: {
    "^": "Closure:29;_convertedObjects_0",
    call$1: [function(o) {
...
["dart_qv_c3_kreisdiagramm", "main.dart", , V, {
  "^": "",
  main: [function() {
    Q.registerQlikViewExtensionObject("DartQvC3Kreisdiagramm", new V.main_closure());
  }, "call$0", "main$closure", 0, 0, 12],
  DartQvC3Kreisdiagramm: {
    "^": "QlikViewExtensionObject;pieChartDiv,qvaWrapper,base$QlikViewExtension$documentHead,objectId,contentDiv",
    onCreate$0: function() {
      var completer0 = H.setRuntimeTypeInfo(new P._AsyncCompleter(H.setRuntimeTypeInfo(new P._Future(0, $.Zone__current, null), [null])), [null]);
      P.scheduleMicrotask(new V.DartQvC3Kreisdiagramm_onCreate_closure(this, completer0));
      return completer0.future;
    },
    onPaint$0: function() {
      var t1, c3PieChartParams;
      t1 = P.LinkedHashMap_LinkedHashMap$_literal(["columns", this.get$dataAsList(), "type", "pie", "onclick", new V.DartQvC3Kreisdiagramm_onPaint_closure(this), "names", this.get$idNameMap()], null, null);
      c3PieChartParams = P.LinkedHashMap_LinkedHashMap$_literal(["bindto", this.pieChartDiv, "data", t1, "legend", P.LinkedHashMap_LinkedHashMap$_literal(["show", J.$eq(J.$index$asx(J.$index$asx(J.$index$asx(this.qvaWrapper, "Layout"), "Text0"), "text"), 1) && true], null, null)], null, null);
      t1 = J.$index$asx($.get$context(), "c3");
      t1.callMethod$2("generate", [P._wrapToDart(P.JsObject__convertDataTree(c3PieChartParams))]);
    }
  },
  DartQvC3Kreisdiagramm_onCreate_closure: {
    "^": "Closure:32;this_0,completer0_1",
    call$0: function() {
      var e, s, t1, t2, t3, exception;
      try {
        t1 = this.this_0;
        J.$indexSet$ax($.get$context(), H.S(J.$index$asx(J.$index$asx(t1.qvaWrapper, "ObjectMgr"), "Extension")) + J.replaceFirst$2$s(t1.objectId, "\\", ""), t1);
        J.append$1$x(t1.contentDiv, t1.pieChartDiv);
        t1.loadStyleSheets$1(["style.css", "c3.min.css"]);
        t2 = t1.loadScripts$1(["d3.min.js", "c3.min.js"]);
        t3 = H.setRuntimeTypeInfo(new P._Future(0, $.Zone__current, null), [null]);
        t3._asyncComplete$1(t2);
        t2 = this.completer0_1;
        t3.then$2$onError(new V.DartQvC3Kreisdiagramm_onCreate__closure(t1, t2), t2.get$completeError());
      } catch (exception) {
        t1 = H.unwrapException(exception);
        e = t1;
        s = new H._StackTrace(exception, null);
        this.completer0_1.completeError$2(e, s);
      }

    }
  },
  DartQvC3Kreisdiagramm_onCreate__closure: {
    "^": "Closure:29;this_2,completer0_3",
    call$1: [function(x0) {
      var e0, s0, exception, t1;
      try {
        this.this_2.onPaint$0();
        this.completer0_3.complete$0(0);
      } catch (exception) {
        t1 = H.unwrapException(exception);
        e0 = t1;
        s0 = new H._StackTrace(exception, null);
        this.completer0_3.completeError$2(e0, s0);
      }

    }, "call$1", null, 2, 0, null, 53, "call"]
  },
  DartQvC3Kreisdiagramm_onPaint_closure: {
    "^": "Closure:33;this_0",
    call$2: [function(data, svgShape) {
      var t1 = H.Primitives_parseInt(J.$index$asx(data, "id"), null, null);
      J.$index$asx(this.this_0.qvaWrapper, "Data").callMethod$2("SelectValuesInColumn", [0, C.JSArray_methods.join$1([t1], " "), false]);
    }, "call$2", null, 4, 0, null, 47, 54, "call"]
  },
  main_closure: {
    "^": "Closure:55;",
    call$1: function(qvaWrapper) {
      var t1, t2, t3;
      t1 = document.createElement("div", null);
      J.get$classes$x(t1).add$1(0, "kreisdiagramm");
      t2 = J.getInterceptor$asx(qvaWrapper);
      t3 = J.$index$asx(t2.$index(qvaWrapper, "Layout"), "ObjectId");
      t2 = t2.$index(qvaWrapper, "Element");
      return new V.DartQvC3Kreisdiagramm(t1, qvaWrapper, H.interceptedTypeCast(document.querySelector("head"), "$isHeadElement"), t3, t2);
    }
  }
},
1],
...
["qlikview_qlik_sense_extensions", "package:qlikview_qlik_sense_extensions/qlikview_qlik_sense_extensions.dart", , Q, {
  "^": "",
  registerQlikViewExtensionObject: function($name, factoryFunc) {
    var jsFunc = P._convertDartFunction(new Q.registerQlikViewExtensionObject_closure(factoryFunc), true);
    J.$index$asx($.get$context(), "Qva").callMethod$2("AddExtension", [$name, new P.JsFunction(jsFunc)]);
  },
  QlikViewExtensionObject: {
    "^": "ExtensionObject_QlikViewExtension;",
    get$remoteAddress: function() {
      var remoteRoot, t1;
      remoteRoot = H.stringTypeCast(J.$index$asx(J.$index$asx($.get$context(), "qva"), "Remote"));
      t1 = H.S(remoteRoot);
      return t1 + (J.contains$1$asx(remoteRoot, "?") ? "&" : "?") + "public=only&name=Extensions/" + H.S(J.$index$asx(J.$index$asx(this.qvaWrapper, "ObjectMgr"), "Extension"));
    },
    get$dataAsList: function() {
      var data, t1, t2, i, t3, row;
      data = H.setRuntimeTypeInfo([], [P.List]);
      t1 = this.qvaWrapper;
      t2 = J.getInterceptor$asx(t1);
      i = 0;
      while (true) {
        t3 = J.$index$asx(J.$index$asx(t2.$index(t1, "Data"), "Rows"), "length");
        if (typeof t3 !== "number")
          return H.iae(t3);
        if (!(i < t3))
          break;
        row = J.$index$asx(J.$index$asx(t2.$index(t1, "Data"), "Rows"), i);
        t3 = J.getInterceptor$asx(row);
        data.push([J.$index$asx(t3.$index(row, 0), "value"), J.$index$asx(t3.$index(row, 1), "data")]);
        ++i;
      }
      return data;
    },
    get$idNameMap: function() {
      var idNameMap, t1, t2, i, t3, row;
      idNameMap = P.LinkedHashMap_LinkedHashMap(null, null, null, P.$int, P.String);
      t1 = this.qvaWrapper;
      t2 = J.getInterceptor$asx(t1);
      i = 0;
      while (true) {
        ...
        row = J.$index$asx(J.$index$asx(t2.$index(t1, "Data"), "Rows"), i);
        t3 = J.getInterceptor$asx(row);
        idNameMap.$indexSet(0, J.$index$asx(t3.$index(row, 0), "value"), J.$index$asx(t3.$index(row, 0), "text"));
        ++i;
      }
      return idNameMap;
    }
  ...
  ExtensionObject_QlikViewExtension: {
    "^": "ExtensionObject+QlikViewExtension;"
  },
  registerQlikViewExtensionObject_closure: {
    "^": "Closure:55;factoryFunc_0",
    call$1: [function(qvaWrapper) {
      var objectId, t1, createdExtension;
      objectId = J.$index$asx(J.$index$asx(qvaWrapper, "Layout"), "ObjectId");
      t1 = $.get$ExtensionObject_extensionMap();
      if (t1.containsKey$1(objectId))
        t1.$index(0, objectId).onPaint$0();
      else {
        createdExtension = new Q.registerQlikViewExtensionObject__closure(this.factoryFunc_0, qvaWrapper).call$0();
        t1.$indexSet(0, objectId, createdExtension);
        createdExtension.onCreate$0();
      }
    }, "call$1", null, 2, 0, null, 56, "call"]
  },
  registerQlikViewExtensionObject__closure: {
    "^": "Closure:32;factoryFunc_1,qvaWrapper_2",
    call$0: function() {
      return this.factoryFunc_1.call$1(this.qvaWrapper_2);
    }
  }
}],
["qlikview_qlik_sense_extensions.base", "package:qlikview_qlik_sense_extensions/src/qlikview_qlik_sense_extensions_base.dart", , S, {
  ...
  QlikViewExtension: {
    "^": "Object;",
    loadScripts$1: function(paths) {
      return this._loadDependencies$2(paths, this.get$loadScript());
    },
    loadStyleSheets$1: function(paths) {
      return this._loadDependencies$2(paths, this.get$loadStyleSheet());
    },
    loadScript$1: [function(path) {
      var scriptElement, t1;
      scriptElement = document.createElement("script", null);
      t1 = J.getInterceptor$x(scriptElement);
      t1.set$src(scriptElement, path);
      t1.set$charset(scriptElement, "UTF-8");
      t1.set$type(scriptElement, "text/javascript");
      return this._appendNodeToHeadAndLoad$1(scriptElement);
    }, "call$1", "get$loadScript", 2, 0, 57],
    loadStyleSheet$1: [function(path) {
      var cssElement, t1;
      cssElement = document.createElement("link", null);
      t1 = J.getInterceptor$x(cssElement);
      t1.set$rel(cssElement, "stylesheet");
      t1.set$type(cssElement, "text/css");
      t1.set$href(cssElement, path);
      return this._appendNodeToHeadAndLoad$1(cssElement);
    }, "call$1", "get$loadStyleSheet", 2, 0, 57],
    _loadDependencies$2: function(paths, loadFunction) {
      var completer, loadTasks, t1, relativePath;
      completer = H.setRuntimeTypeInfo(new P._AsyncCompleter(H.setRuntimeTypeInfo(new P._Future(0, $.Zone__current, null), [null])), [null]);
      loadTasks = H.setRuntimeTypeInfo([], [P.Future]);
      for (t1 = new H.ListIterator(paths, 2, 0, null); t1.moveNext$0();) {
        relativePath = t1._current;
        loadTasks.push(loadFunction.call$1(this.get$remoteAddress() + "/" + H.S(relativePath)));
      }
      P.Future_wait(loadTasks, false).then$1(new S.QlikViewExtension__loadDependencies_closure(completer));
      return completer.future;
    },
    _appendNodeToHeadAndLoad$1: function(node) {
      var completer, t1;
      completer = H.setRuntimeTypeInfo(new P._AsyncCompleter(H.setRuntimeTypeInfo(new P._Future(0, $.Zone__current, null), [null])), [null]);
      t1 = J.get$onLoad$x(node);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._html$_target, t1._eventType, W._wrapZone(new S.QlikViewExtension__appendNodeToHeadAndLoad_closure(completer)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      this.base$QlikViewExtension$documentHead.appendChild(node);
      return completer.future;
    }
  },
  QlikViewExtension__loadDependencies_closure: {
    "^": "Closure:59;completer_0",
    call$1: [function(results) {
      return this.completer_0.complete$0(0);
    }, "call$1", null, 2, 0, null, 58, "call"]
  },
  QlikViewExtension__appendNodeToHeadAndLoad_closure: {
...
;(function() {
  ...
  _.$isSymbol = TRUE;
  _.$isObject = TRUE;
  S.ExtensionObject.$isObject = TRUE;
  _ = P.List;
  _.$isList = TRUE;
  _.$isObject = TRUE;
  _ = P.Future;
...
//# sourceMappingURL=QvsViewClient.aspx?public=only&type=object&name=Extensions/DartQvC3Kreisdiagramm/main.dart.js.map
