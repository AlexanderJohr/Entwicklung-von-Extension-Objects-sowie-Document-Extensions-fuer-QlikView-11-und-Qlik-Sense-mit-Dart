...
["DartDownloadArbeitsblattAlsPng", "main.dart", , U, {
  "^": "",
  main: [function() {
    Q.registerQlikViewDocumentExtension(new U.main_closure());
  }, "call$0", "main$closure", 0, 0, 0],
  DartDownloadArbeitsblattAlsPng: {
    "^": "QlikViewDocumentExtension;name,base$QlikViewExtension$documentHead",
    onCreate$0: function() {
      ...
      P.scheduleMicrotask(new U.DartDownloadArbeitsblattAlsPng_onCreate_closure(this, completer0));
      return completer0.future;
    },
    onKeyDown$1: [function(_, $event) {
      if (121 === J.get$keyCode$x($event)) {
        $.get$context().callMethod$1("canvg");
        this.downloadSheetAsPng$1(this.get$sheetSize());
      }
    }, "call$1", "get$onKeyDown", 2, 0, 31, 32],
    downloadSheetAsPng$1: function(sheetSize) {
      var t1, t2, t3;
      t1 = $.get$context();
      t2 = document.body;
      t3 = P.LinkedHashMap_LinkedHashMap$_literal(["width", sheetSize.left + sheetSize.width, "height", sheetSize.top + sheetSize.height, "onrendered", new U.DartDownloadArbeitsblattAlsPng_downloadSheetAsPng_closure()], null, null);
      t1.callMethod$2("html2canvas", [t2, P._wrapToDart(P.JsObject__convertDataTree(t3))]);
    },
    get$sheetSize: function() {
      var elements, t1, maxRight, maxBottom, element, t2, t3;
      elements = W._FrozenElementList$_wrap(document.querySelectorAll("#MainContainer *"), null);
      for (t1 = elements.get$iterator(elements), maxRight = 0, maxBottom = 0; t1.moveNext$0();) {
        element = t1.__internal$_current;
        t2 = J.getInterceptor$x(element);
        t3 = t2.get$offset(element);
        maxRight = P.max(maxRight, t3.get$right(t3));
        t2 = t2.get$offset(element);
        maxBottom = P.max(maxBottom, t2.get$bottom(t2));
      }
      return P.Rectangle$(0, 0, maxRight, maxBottom, null);
    }
  },
  DartDownloadArbeitsblattAlsPng_onCreate_closure: {
    "^": "Closure:33;this_0,completer0_1",
    call$0: function() {
      var e, s, t1, t2, t3, exception;
      try {
        t1 = this.this_0;
        J.$indexSet$ax($.get$context(), t1.name, t1);
        t2 = t1.loadScripts$1(["html2canvas.js", "rgbcolor.js", "StackBlur.js", "canvg.js"]);
        t3 = H.setRuntimeTypeInfo(new P._Future(0, $.Zone__current, null), [null]);
        t3._asyncComplete$1(t2);
        t2 = this.completer0_1;
        t3.then$2$onError(new U.DartDownloadArbeitsblattAlsPng_onCreate__closure(t1, t2), t2.get$completeError());
      } catch (exception) {
  ...
  DartDownloadArbeitsblattAlsPng_onCreate__closure: {
    "^": "Closure:28;this_2,completer0_3",
    call$1: [function(x0) {
      var e0, s0, t1, t2, exception;
      try {
        t1 = H.setRuntimeTypeInfo(new W._EventStream(document, "keydown", false), [null]);
        t2 = this.this_2;
        H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._html$_target, t1._eventType, W._wrapZone(t2.get$onKeyDown(t2)), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
  ...
  DartDownloadArbeitsblattAlsPng_downloadSheetAsPng_closure: {
    "^": "Closure:36;",
    call$1: [function(canvas) {
      var t1, e;
      t1 = J.toDataUrl$0$x(canvas);
      e = document.createElement("a", null);
      if (t1 != null)
        J.set$href$x(e, t1);
      t1 = J.getInterceptor$x(e);
      t1.set$download(e, "print.png");
      t1.click$0(e);
  ...
  main_closure: {
    "^": "Closure:33;",
    call$0: function() {
      return new U.DartDownloadArbeitsblattAlsPng("DartDownloadArbeitsblattAlsPng", H.interceptedTypeCast(document.querySelector("head"), "$isHeadElement"));
    }
  }
},
1],
...
["_js_helper", "dart:_js_helper", , H, {
  ...
  Primitives_functionNoSuchMethod_closure: {
    "^": "Closure:39;box_0,arguments_1,namedArgumentList_2",
  ...
  Primitives_applyFunction_closure: {
    "^": "Closure:39;box_0,defaultArguments_1",
...
["dart.async", "dart:async", , P, {
  ...
  Future_wait_handleError: {
    "^": "Closure:37;box_0,eagerError_1,result_2",
    ...
    }, "call$2", null, 4, 0, null, 43, 44, "call"]
  },
  Future_wait_closure: {
    "^": "Closure:45;box_0,eagerError_3,result_4,pos_5",
  ...
  _Completer: {
    ...
    }, "completeError$1", "call$2", "call$1", "get$completeError", 2, 2, 46, 15, 16, 17]
  },
  _AsyncCompleter: {
    "^": "_Completer;future",
...
["qlikview_qlik_sense_extensions", "package:qlikview_qlik_sense_extensions/qlikview_qlik_sense_extensions.dart", , Q, {
  "^": "",
  registerQlikViewDocumentExtension: function(factoryFunc) {
    var createdExtension, t1;
    createdExtension = factoryFunc.call$0();
    t1 = J.get$name$x(createdExtension);
    J.$index$asx($.get$context(), "Qva").callMethod$2("AddDocumentExtension", [t1, new Q.registerQlikViewDocumentExtension_closure(createdExtension)]);
  },
  QlikViewDocumentExtension: {
    "^": "Extension_QlikViewExtension;name>",
    get$remoteAddress: function() {
      var remoteAddress, t1;
      remoteAddress = H.stringTypeCast(J.$index$asx(J.$index$asx($.get$context(), "qva"), "Remote"));
      t1 = H.S(remoteAddress);
      return t1 + (J.contains$1$asx(remoteAddress, "?") ? "&" : "?") + "public=only&type=document&name=Extensions/" + this.name;
    }
  },
  Extension_QlikViewExtension: {
    "^": "Extension+QlikViewExtension;"
  },
  registerQlikViewDocumentExtension_closure: {
    "^": "Closure:33;createdExtension_0",
    call$0: [function() {
      return this.createdExtension_0.onCreate$0();
    }, "call$0", null, 0, 0, null, "call"]
  }
}],
["qlikview_qlik_sense_extensions.base", "package:qlikview_qlik_sense_extensions/src/qlikview_qlik_sense_extensions_base.dart", , S, {
  ...
  QlikViewExtension: {
    ...
    _loadDependencies$2: function(paths, loadFunction) {
      ...
      for (t1 = new H.ListIterator(paths, 4, 0, null); t1.moveNext$0();) {
        relativePath = t1.__internal$_current;
...
//# sourceMappingURL=QvsViewClient.aspx?public=only&type=document&name=Extensions/DartDownloadArbeitsblattAlsPng/main.dart.js.map
